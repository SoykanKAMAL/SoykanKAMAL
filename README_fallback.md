...
> init user_profile
> INITIALIZING<span style="animation: blink 1s step-start infinite;">.</span><span style="animation: blink 1s step-start 0.1s infinite;">.</span><span style="animation: blink 1s step-start .2s infinite;">.</span>
</pre>
...
> Recombobulating<span style="animation: blink 1s step-start infinite;">.</span><span style="animation: blink 1s step-start 0.1s infinite;">.</span><span style="animation: blink 1s step-start .2s infinite;">.</span>
</pre>
...
> Flabbergasting<span style="animation: blink 1s step-start infinite;">.</span><span style="animation: blink 1s step-start 0.1s infinite;">.</span><span style="animation: blink 1s step-start .2s infinite;">.</span>
</pre>
...
> Concocting<span style="animation: blink 1s step-start infinite;">.</span><span style="animation: blink 1s step-start 0.1s infinite;">.</span><span style="animation: blink 1s step-start .2s infinite;">.</span>
</pre>
...
> Constellationizing<span style="animation: blink 1s step-start infinite;">.</span><span style="animation: blink 1s step-start 0.1s infinite;">.</span><span style="animation: blink 1s step-start .2s infinite;">.</span>
</pre>
...
> _ <span style="animation: cursor-blink 1s step-start infinite;">|</span>
</pre>
</div>
